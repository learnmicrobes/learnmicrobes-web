// Visual Atlas card content. It lives apart from the renderers in VisualAtlas.tsx so
// the build can read card titles for the content index (scripts/build-content-index.cjs)
// and so pages that only need card text do not also load the drawing code.
